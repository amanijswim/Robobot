...
public class RobotMap {
    ...
    public static CANTalon driveTrainRigthFront;
    ...
    public static void init() {
        ...
        driveTrainRigthFront = new CANTalon(2);
        LiveWindow.addActuator("Drive Train", "Rigth Front", driveTrainRigthFront);
        
        driveTrainRightRear = new CANTalon(3);
